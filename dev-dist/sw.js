...
define(['./workbox-f87553f6'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/\/_next\/static\/.*/i, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/\/api\/notes\/.*/i, new workbox.NetworkFirst({
  ...
  workbox.registerRoute(/\/api\/grades\/.*/i, new workbox.NetworkFirst({
